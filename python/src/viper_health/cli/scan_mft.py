    ...
    try:
        ...
        if analysis["overall_severity"] != "good":
            ...
            if analysis["size_severity"] == "critical":
                ...
                print("   Threshold: >2.5 GB indicates severe metadata pressure")
                ...
                print("   Threshold: >2.0 GB suggests growing metadata pressure")
            ...
            if analysis["fragmentation_severity"] == "critical":
                ...
                print("   Threshold: >10 fragments severely impacts performance")
                print(f"\n   {Style.BRIGHT}Why This Matters:{Style.RESET_ALL}")
                ...
                print("   Threshold: >5 fragments may impact performance")
                print(f"\n   {Style.BRIGHT}Recommended Actions:{Style.RESET_ALL}")
